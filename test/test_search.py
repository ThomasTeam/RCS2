...
class TestDatabase(unittest.TestCase):
    ...
    def test_serch_author_by_name_using_part_name(self):
        ...
        db.read(path.join(self.data_dir, "dblp_curated_sample.xml"))
        #data = db.search_author_by_name("author1")
        self.assertEqual(db.search_author_by_name("Carl"),[["Carlo Zaniolo",0,0,1,0,1,5],["Carlos Eduardo Scheidegger",0,1,0,0,1,49],["Carlo Siciliano",1,0,0,0,1,2],["Carlos N. Cumberbatch",1,0,0,0,1,2],["Giancarlo Martella",1,1,0,0,2,2],["Carl Kesselman",2,0,0,0,2,2],["Carlo Conserva", 2, 0, 0, 0, 2, 10],["Carlo Batini", 6, 3, 1, 0, 10, 15]])
    ...
    def test_serch_author_by_name_sorting_equals(self):
        ...
        db.read(path.join(self.data_dir, "dblp_curated_sample.xml"))
        #data = db.search_author_by_name("author1")
        self.assertEqual(db.search_author_by_name("Carl","1,1","1"),[["Carlo Zaniolo",0,0,1,0,1,5],["Carlos Eduardo Scheidegger",0,1,0,0,1,49],["Carlo Siciliano",1,0,0,0,1,2],["Carlos N. Cumberbatch",1,0,0,0,1,2],["Giancarlo Martella",1,1,0,0,2,2],["Carl Kesselman",2,0,0,0,2,2],["Carlo Conserva", 2, 0, 0, 0, 2, 10],["Carlo Batini", 6, 3, 1, 0, 10, 15]])
